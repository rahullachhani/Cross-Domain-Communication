...
<html>
       ...
       <link type="text/css" href="chatMain.css" rel="stylesheet" />
        ...
        <script type="text/javascript">
            ...
            <%
                ...
                if (!found) {
                    ...
                    try {
                        ...
                        XMPPConnections.add(xmppManager1);
                         out.println("alert('"+XMPPConnections+"');");
                ...
                out.println("alert('Chat executed');");
    ...
    <body onunload="">
        <input type ="button" value="Login" id="loginbutton" onclick="showlogin();" >
            <br>
             <div id="logindiv" style='display: none;'>
            <form  onsubmit="return check();"  >
                <fieldset>
                    <legend>Login</legend>
                    <label>UserName :</label> <input id='userName1' type="text" name="userName1" /><br/>
                    <label>Password :</label> <input id='password1' type="password" name="password1" /><br/>
                    <label>Domain :</label> <input id='domain1' type="text" name="domain1" value=''/><br/>
                    <input style='position:relative;left:110px;top:5px' type="button" value="Login" id="opennewchat" onclick="shownewlogin();" />
                </fieldset>
            </form>
        </div>
        <br>
 ...
 <!--<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js">
  ...
  <script>
             function check(){
                 ...
                 if(domain==''){ alert("Please Enter Domain"); return false;}
        ...
        type:'POST',
        url:'chat2.jsp',
        data: { userName: "<%=userName%>", password: "<%=password%>", domain: "<%=domain%>", userName1:      
        $('#userName1').val(), password1: $('#password1').val(), domain1: $('#domain1').val() },
        success:function(result){
            
      $("#newchat").append(result);
...
//   $("opennewchat").click(function(){
//     $.ajax({
//         type:'POST',
//         url:'chat2.jsp',
//         data: { userName: $('#userName').val(), password: $('#password').val(), domain: $('#domain').val() },
//         success:function(result){
//       $("#newchat").html(result);
//     }});
//   });
